...
<div class="post-found-container">
    <div class="col-12">
        ...
        <form action="{{route('admin.put.profile',['id'=>$user->id])}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row ">
                    ...
                    <div class="col-6">
                        <div class="user-info mt-4">
                            ...
                            <div class="row user-input-info">
                                <input type="text" class="input-feild" name="phone_numner" value="{{$user->address}}" id="name"  placeholder="Enter phone number.." aria-describedby="textHelp">
                            </div>
