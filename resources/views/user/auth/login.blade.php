...
<script>
    ...
    <div class="login-page">
        <div style="width: 400px; margin: auto; background-color: white; padding: 20px;">
            ...
            <form action="{{route('user.post.login')}}" class="text-dark" method="POST" >
                 @csrf
                <div class="mb-4">
                ...
                <div style="display: flex; justify-content: space-around; align-items: center; margin-top: 40px;">
                    <p class="ms-3" style="color: rgb(72, 72, 252);">Forgot Password</p>
                    <button class="login-btn" type="submit">Log-In</button>
                </div>
                <div class="text-center mt-5">
                    <p style="color: rgb(72, 72, 252);">New Here? <a href="{{route('user.register')}}">Register</a></p>
                    <p style="color: rgb(72, 72, 252);"><a href="{{route('admin.login')}}">Admin Log-In</a></p>
                </div>
            </form>
        </div>
    </div>
