...
<script>
    ...
    <div class="login-page">
        <div style="width: 400px; margin: auto; background-color: white; padding: 20px;">
            ...
            <form action="{{route('user.post.register')}}" class="text-dark" method="POST" >
                @csrf
                <div class="mb-4">
                    <label for="name" class="ms-3">Name</label>
                    <input type="text" name="name" class="input-feild" id="name"
                ...
                <div class="text-center mt-5">
                    <p style="color: rgb(72, 72, 252);">already have acoount? <a href="{{route('user.login')}}">Log-In</a></p>
