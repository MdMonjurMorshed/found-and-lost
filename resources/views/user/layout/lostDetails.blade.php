        ...
        <h4 class="p-2" style="color: black;font-size:20px; display:flex;justify-content:center">Lost Item Details</h4>
            ...
            <div class="row ">
                    ...
                    <div class="col-6">
                        ...
                        @if ($lostitem->user_id != Auth::user()->id)
                            <form action="{{route('user.reportitem',['lostitem'=>$lostitem])}}" id="claim-form"  method="GET">
                                    
                                    
                                    <button class="post-found-btn" type="submit" >Report Item</button>
                        ...
                        @else
                            <form action="{{route('user.lost.return',['lostitem'=>$lostitem])}}" id="return-claim-form"  method="GET">
                                    
                                    
                                    <button class="post-found-btn" type="submit" >Got Item Back</button>
