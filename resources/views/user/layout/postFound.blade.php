...
@section('title','post found item')

@section('content-main')

<div class="post-found-container">
    <div class="col-12">
        <h4 class="p-2" style="color: black;font-size:20px; display:flex;justify-content:center"s>Post A Found Item</h4>
        <form action="{{route('user.post.found.add')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row ">
                    <div class="col-6  ">
                    ...
                    <div class="col-6">
                        ...
                        <div class="post-found-btn-holder">
                            <button class="post-found-btn" type="submit">Post A Found Item</button>
